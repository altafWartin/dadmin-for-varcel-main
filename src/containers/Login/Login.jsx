    ...
    <div className="w-full relative px-8 pt-8 pb-8 h-screen bg-ghostwhite shadow-md overflow-hidden flex items-center justify-center">
      ...
      <Formik
        ...
        onSubmit={async (values, { setSubmitting }) => {
          ...
          try {
            ...
            const { token, data: { findUser } } = data; // Updated line to extract token and findUser
            ...
            navigate("/"); // Assuming navigate("/") is your navigation function
          } catch (error) {
      ...
      >
        {({ handleSubmit, isSubmitting }) => (
          <form onSubmit={handleSubmit} className="mx-10  w-full md:w-1/4 max-w-[500px] rounded-3xl bg-white pt-4 pb-4 pr-4 pl-4 gap-2 z-2 md:pl-6 md:pr-6 md:box-border lg:pt-5 lg:pb-5 lg:box-border">
            <div className="w-full flex flex-col items-center justify-start gap-1">
              <img className="w-9 h-8 relative" loading="eager" alt="" src={logo} />
            ...
            <div className="w-full flex flex-col items-center justify-center">
              <button
                type="submit" disabled={isSubmitting}// Pass the event object to handleLogin
            ...
            <div className="w-full mt-3 flex flex-row items-start justify-start gap-1">
              ...
              <Link to="/signUp" className="text-sm leading-5 font-medium font-poppins text-coral text-left">
                SignUp
              </Link>
            </div>
          </form>
